export default {
    ...
    settings_player_subs_lang: 'Мова субтитрів',
    settings_player_subs_lang_descr: 'Які субтитри вмикати автоматично, якщо доступно кілька мов',
    settings_param_subtitles_lang_auto: 'Мова інтерфейсу',
