export default {
    ...
    settings_player_subs_lang: 'Мова субтытраў',
    settings_player_subs_lang_descr: 'Якія субтытры ўключаць аўтаматычна, калі даступна некалькі моў',
    settings_param_subtitles_lang_auto: 'Мова інтэрфейсу',
