export default {
    ...
    settings_player_subs_lang: 'Idioma das legendas',
    settings_player_subs_lang_descr: 'Quais legendas ativar automaticamente quando houver vários idiomas',
    settings_param_subtitles_lang_auto: 'Idioma da interface',
