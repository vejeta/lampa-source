export default {
    ...
    settings_player_subs_lang: 'Язык субтитров',
    settings_player_subs_lang_descr: 'Какие субтитры включать автоматически, если доступно несколько языков',
    settings_param_subtitles_lang_auto: 'Язык интерфейса',
