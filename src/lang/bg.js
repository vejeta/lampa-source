export default {
    ...
    settings_player_subs_lang: 'Език на субтитрите',
    settings_player_subs_lang_descr: 'Кои субтитри да се включват автоматично, когато има няколко езика',
    settings_param_subtitles_lang_auto: 'Език на интерфейса',
